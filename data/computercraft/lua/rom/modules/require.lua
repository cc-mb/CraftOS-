...
local function make_package(env, dir)
    ...
    -- Patch MilanBorovy
    -- Add /lib & /usr/lib path
    package.path = "?;?.lua;?/init.lua;/usr/lib/?;/usr/lib/?.lua;/usr/lib/?/init.lua;/lib/?;/lib/?.lua;/lib/?/init.lua;/rom/modules/main/?;/rom/modules/main/?.lua;/rom/modules/main/?/init.lua"
    if turtle then
